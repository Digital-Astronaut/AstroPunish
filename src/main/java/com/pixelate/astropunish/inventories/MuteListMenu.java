...
public class MuteListMenu extends PaginatedMenu {
    ...
    public MuteListMenu(PlayerMenuUtility playerMenuUtility, Menu previousMenu) {
    ...
    public void loopData(Object o) {
        ...
        if (o instanceof PunishedPlayer p) {
            ...
            lore.add(Component.text("Currently muted: " + p.isMuted(), NamedTextColor.LIGHT_PURPLE));
            lore.add(Component.text("Amount of mutes: " + p.getPlayerMuteAmount(), NamedTextColor.AQUA));
    ...
    public String getMenuName() {
        return ChatColor.RED + "Mute History";
    }
    ...
    public void handleMenu(InventoryClickEvent e) {
        ...
        if (e.getRawSlot() < getSlots() - 9) {
            ...
            if (e.getCurrentItem().getItemMeta().hasDisplayName()) {
                ...
                new MutedPlayerMenu(MenuManager.getPlayerMenuUtility((Player) e.getWhoClicked()), Bukkit.getOfflinePlayer(
